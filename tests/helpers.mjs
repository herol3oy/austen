...
export const svg =
	'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 100"><g><text x="10" y="20">Elizabeth Bennet</text><path d="M10 30 L250 30"/><text x="180" y="50">Jane Bennet</text></g></svg>'
...
export async function fixtureRoot(t, { directory = tmpdir() } = {}) {
	...
	return {
		...
		book,
		catalog,
		path: resolve(root, 'data/maps', book.slug, 'v1.json'),
	}
}
