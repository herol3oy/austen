...
| `/austen/genres/` | Directory of genres with published maps; hub pages group maps by catalog category |
| `/austen/eras/` | Directory of publication-era (century) hubs derived from each book's year |
